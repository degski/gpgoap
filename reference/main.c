...
int main( int argc, char* argv[] )
{
	...
	worldstate_t goal;
	goap_worldstate_init( &goal );
	goap_worldstate_set( &ap, &goal, "enemyalive", false );
	goap_worldstate_set( &ap, &goal, "alive", false ); // add this to avoid suicide actions in plan.
